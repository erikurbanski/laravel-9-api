...
return [
    ...
    'description' => 'Esta é a documentação do ' . config('app.name') . ', as informações aqui provida são suficientes para o completo uso do sistema',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'Para obter seu token faça a requisição para o endpoint  <b>auth/login</b>.',
    ],
